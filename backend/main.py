...
from config import API_USER_INFO, API_USER_STATUS
...
def codeforces():
    ...
    return render_template("codeforces.html", userhandle=userhandle, problems=problems, tags=tags['tags'], correct_cnt=0, user_verdicts={})
